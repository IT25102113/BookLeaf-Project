        ...
        <div class="md:w-2/3 p-10 flex flex-col">
            <div class="flex items-start justify-between mb-4">
                ...
                <div class="text-right">
                    <p class="text-3xl font-black text-primary">$${String.format("%.2f", book.price)}</p>
                    <c:if test="${book.hasEbook}"><p class="text-sm text-secondary mt-1">E-Book: <span class="text-primary font-bold">$${String.format("%.2f", book.price * 0.8)}</span> <span class="text-xs bg-secondary/10 text-secondary px-2 py-0.5 rounded-full">20% OFF</span></p></c:if>
                </div>
            </div>
            <div class="flex items-center gap-2 mb-4">
                ...
                <span class="text-sm text-secondary">${String.format("%.1f", avgRating)} (${reviewCount} reviews)</span>
            </div>
